...
// funziona nella quale viene preso l'input dell'utente (movimento, proiettile, uscita, pausa)
void* movimentoRana(void* _rana);

// funzione che gestisce il movimento del proiettile
void* funzProiettile(void* _proiettile);

// funzione che stampa la sprite della rana del colore scelto dall'utente e il suo sfondo in base al terreno sopra il quale si trova
